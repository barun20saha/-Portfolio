...
const LOCAL_STORAGE_KEY = 'barun20saha_visitor_count';
...
export const useVisitorCount = (): number => {
  ...
  useEffect(() => {
    const hasVisitedThisSession = sessionStorage.getItem('barun20saha_visited_session');
      ...
      if (databaseId) {
        try {
          ...
          if (!hasVisitedThisSession) {
            ...
            sessionStorage.setItem('barun20saha_visited_session', 'true');
