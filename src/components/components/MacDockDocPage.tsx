...
export default function MacDockDocPage() {
  ...
  const cliCommands: Record<PackageManager, string> = {
    pnpm: 'pnpm dlx shadcn@latest add https://barun20saha.vercel.app/r/mac-dock.json',
    npm: 'npx shadcn@latest add https://barun20saha.vercel.app/r/mac-dock.json',
    yarn: 'npx shadcn@latest add https://barun20saha.vercel.app/r/mac-dock.json',
    bun: 'bunx --bun shadcn@latest add https://barun20saha.vercel.app/r/mac-dock.json',
  };
