...
export default function LoaderDocPage() {
  ...
  const cliCommands: Record<PackageManager, string> = {
    pnpm: 'pnpm dlx shadcn@latest add https://barun20saha.vercel.app/r/loader-animation.json',
    npm: 'npx shadcn@latest add https://barun20saha.vercel.app/r/loader-animation.json',
    yarn: 'npx shadcn@latest add https://barun20saha.vercel.app/r/loader-animation.json',
    bun: 'bunx --bun shadcn@latest add https://barun20saha.vercel.app/r/loader-animation.json',
  };
