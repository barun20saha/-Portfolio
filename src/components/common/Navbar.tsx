    ...
    <>
      <div className="bg-background dark:bg-[#050505] sticky top-0 isolate z-50 pt-1">
        <Container>
          <div>
            <motion.div
              className={`relative m-auto mt-1 flex w-full max-w-screen items-center justify-between gap-2 overflow-visible px-4 py-1.5 transition-shadow duration-300 data-[affix=true]:shadow-[0_0_16px_0_black]/8 dark:data-[affix=true]:shadow-[0_0_16px_0_black]`}
            >
              <div>
                <Link href="/">
                  <h2 className={`${pixelify.className} text-2xl uppercase`}>BARUN</h2>
                </Link>
              </div>
